...
import p.lodz.Repositiories.MongoImplementations.PurchaseRespositoryMongoDB;
...
//        final MongoClient mongoClient = MongoClients.create(connectionString);
        try(AbstractMongoRepository repository = new AbstractMongoRepository();) {
            ...
            PurchaseRepository purchaseRepository = new PurchaseRespositoryMongoDB(mongoDatabase.getCollection("purchases", Purchase.class));
